...
public class TableuCardPileTest {

  public static Deque<Card> QUEEN_STRAIGHT_RED =
  ...
  public static Deque<Card> KING_STRAIGHT_BLACK =
      Queues.newArrayDeque(
          Lists.newArrayList(
  ...
  public void pushPile() {
    ...
    CardPile queenPile = new TableuCardPile(QUEEN_STRAIGHT_RED, 1);
